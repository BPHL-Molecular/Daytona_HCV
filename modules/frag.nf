process frag {
    ...
    singularity exec docker://staphb/bwa:0.7.17 bwa mem ${params.reference}/KC248195.fasta ${mypath}/\${samplename}_1.fq.gz ${mypath}/\${samplename}_2.fq.gz> ${mypath}/alignment/aln-se.sam
