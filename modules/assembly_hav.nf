process assembly {
    ...
    singularity exec docker://staphb/samtools:1.12 samtools mpileup -A -d 8000 --reference ${params.reference}/NC_001489.fasta -B -Q 0 ${mypath}/alignment/\${samplename}.sorted.bam | ivar variants -r ${params.reference}/NC_001489.fasta -m 10 -p ${mypath}/variants/\${samplename}.variants -q 20 -t 0.25 -g ${params.reference}/NC_001489.gff3
    ...
    singularity exec docker://staphb/samtools:1.12 samtools mpileup -A -B -d 8000 --reference ${params.reference}/NC_001489.fasta -Q 0 ${mypath}/alignment/\${samplename}.sorted.bam | ivar consensus -t 0 -m 10 -n N -p ${mypath}/assembly/\${samplename}.consensus
